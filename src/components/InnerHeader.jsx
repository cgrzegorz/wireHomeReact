...
function Header({ className = "", scroll = false }) {
  ...
  return (
    <header
      className={`main-header header-style-six style-two ${className || ""}`}
    >
        ...
        <div className="inner-container">
          ...
          <div className="top-center">
            <ul className="list-style-one light">
              ...
              <li>
                <i className="far fa-map-marker"></i> 88 Broklyn Golden Street.
                New York
              </li>
            </ul>
          </div>
          ...
          <div className="outer-box2">
            ...
            <div className="outer-box">
              <button
                ...
                onClick={() => toggleMenu("isSearchPopupOpen")}
              >
              ...
              <div className="btn-box style-two">
                <Link
                  to="/page-contact"
                  className="theme-btn btn-style-one hvr-light bg-orange"
                >
