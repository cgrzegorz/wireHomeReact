                  ...
                  <div className="widget-content">
                    ...
                    <ul className="contact-info">
                      <li>
                        ...
                        <Link to="mailto:needhelp@yourdomain.com">
                      ...
                      <li>
                        ...
                        <Link to="tel:+001112223333">+00 111 222 3333</Link>
                        <br />
                      </li>
                    </ul>
                  </div>
          ...
          <div className="auto-container">
            <div className="inner-container">
              <div className="copyright-text">
                &copy; 2025 <Link to="/">Electrica</Link> | All Rights Reserved
                | <Link to="/">ThemeMascot</Link>
              </div>
            </div>
          </div>
        </div>
