              ...
              <div className="blog-details__left">
                ...
                <div className="blog-details__content">
                  ...
                  <h3 className="blog-details__title">
                    Delivering the best electrician agency
                  </h3>
                  <p className="blog-details__text-2">
                    ...
                    Phasellus a rhoncus erat. Vivamus vel eros vitae est
                    aliquet{" "}
                  </p>
                  <p className="blog-details__text-2">
                    Mauris non dignissim purus, ac commodo diam. Donec sit amet
                ...
                <div className="blog-details__bottom">
                  <p className="blog-details__tags">
                    {" "}
                    <span>Tags</span> <Link to="/news-details">Business</Link>{" "}
                ...
                <div className="nav-links">
                  <div className="prev">
                    <Link to="/news-details" rel="prev">
                      Bring to the table win-win survival strategies
                    </Link>
                  </div>
                  <div className="next">
                    <Link to="/news-details" rel="next">
                  ...
                  <ul className="sidebar__comments-list list-unstyled">
                    <li>
                      ...
                      <div className="sidebar__comments-text-box">
                        <p>
                          A wordpress commenter on <br /> launch new mobile app
                        </p>
                      </div>
                    </li>
                    <li>
