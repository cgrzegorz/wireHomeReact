          ...
          <div className="row">
            <div className="title-column col-xl-4 col-lg-4 col-md-12">
              <div className="inner-column">
                <div className="sec-title">
                  <span className="sub-title">NASZ BLOG</span>
                  <h2>
                    Sprawdź najnowsze
                    <br /> wpisy na blogu
                  </h2>
                  <div className="text">
                    Dzielimy się praktycznymi poradami i ciekawostkami ze świata
                    instalacji elektrycznych. Zobacz, nad czym aktualnie
                    pracujemy.
                  </div>
                </div>
              </div>
            ...
            <div className="carousel-column col-xl-8 col-lg-8 col-md-12">
              <div className="carousel-outer">
                <Swiper
                  {...swiperOptions}
                  className="news-carousel owl-theme default-dots"
                >
                    ...
                    <div className="inner-box">
                      ...
                      <div className="content-box">
                        <ul className="post-info">
                          ...
                          <li>
                            <i className="fa fa-tag"></i> electrical
                          </li>
                        </ul>
                        <h4 className="title">
                          <Link to="/news-details">
                            Smart Home Wiring A Guide for Modern Electricians
                          </Link>
                        </h4>
                      </div>
                  ...
                  <SwiperSlide className="news-block wow fadeInUp">
                    <div className="inner-box">
                      ...
                      <div className="content-box">
                        ...
                        <h4 className="title">
                          <Link to="/news-details">
                            Emergency Electrical Repairs What You Need to Do
                          </Link>
                        </h4>
                      </div>
                      <div className="bottom-box">
                  ...
                  <SwiperSlide className="news-block wow fadeInUp">
                    <div className="inner-box">
                      ...
                      <div className="content-box">
                        ...
                        <h4 className="title">
                          <Link to="/news-details">
                            Powering Up: Innovations in Electrical Technology
                          </Link>
                        </h4>
                      </div>
                      <div className="bottom-box">
